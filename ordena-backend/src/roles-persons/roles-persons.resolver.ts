...
export class RolesPersonsResolver {
  ...
  createRolesPerson(@Args('createRolesPersonInput') createRolesPersonInput: CreateRolesPersonInput) {
  ...
  @Mutation(() => RolesPerson)
  updateRolesPerson(@Args('updateRolesPersonInput') updateRolesPersonInput: UpdateRolesPersonInput) {
    return this.rolesPersonsService.update(updateRolesPersonInput.id_role_person, updateRolesPersonInput);
  }
