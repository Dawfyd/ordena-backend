...
export class ProductsOrderedResolver {
  constructor(private readonly productsOrderedService: ProductsOrderedService) {}

  @Mutation(() => ProductsOrdered)
  createProductsOrdered(@Args('createProductsOrderedInput') createProductsOrderedInput: CreateProductsOrderedInput) {
  ...
  @Mutation(() => ProductsOrdered)
  updateProductsOrdered(@Args('updateProductsOrderedInput') updateProductsOrderedInput: UpdateProductsOrderedInput) {
    return this.productsOrderedService.update(updateProductsOrderedInput.id_product_ordered, updateProductsOrderedInput);
  }
