...
export class ModifiersResolver {
  ...
  @Mutation(() => Modifier)
  createModifier(@Args('createModifierInput') createModifierInput: CreateModifierInput) {
  ...
  @Mutation(() => Modifier)
  updateModifier(@Args('updateModifierInput') updateModifierInput: UpdateModifierInput) {
    return this.modifiersService.update(updateModifierInput.id_modifier, updateModifierInput);
  }
